...
% C4ange log:
% Oct 20190:    JS added some extra reporters and warning, so that it tells me if it
%               reaches 400 steps
...
% Only allow up to max_iter gradient steps, but make sure there are at least 10
% gradient descent steps
while t < max_iter && (t < 10 || diff > diffThreshold)
    
    % Make parameter step:
    db_old = db_new;
    db_new = stepSize*(dEdb + db_old);
